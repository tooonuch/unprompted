class Shortcode():
	...
	def ui(self, gr):
		return [gr.Textbox(label="Shortcode names separated by space 🡢 arg_verbatim", max_lines=1, placeholder='txt2mask after repeat'), gr.Checkbox(label="Enable Toggle mode to re-activate shortcodes that were previously bypassed 🡢 _toggle")]
