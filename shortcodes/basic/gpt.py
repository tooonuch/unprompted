class Shortcode():
	...
	def run_block(self, pargs, kwargs, context, content):
		...
		task = self.Unprompted.parse_arg("task", "text-generation")
		...
		max_length = self.Unprompted.parse_arg("max_length", 50)

		min_length = self.Unprompted.parse_arg("min_length", 1)

		num_return_sequences = 1

		model_dir = f"{self.Unprompted.base_dir}/{self.Unprompted.Config.subdirectories.models}/gpt"

		model_name = self.Unprompted.parse_arg("model", "LykosAI/GPT-Prompt-Expansion-Fooocus-v2")
